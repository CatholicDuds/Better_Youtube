...
-- Contagem privada usada pela Edge Function de pesquisa para proteger a cota da API.
...
create index if not exists youtube_search_usage_user_created_idx
on public.youtube_search_usage (user_id, created_at desc);
